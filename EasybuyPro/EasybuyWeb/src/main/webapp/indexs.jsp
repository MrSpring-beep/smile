		...
		<form name=alipayment action=${pageContext.request.contextPath}/alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input type="text" value="<%=UUID.randomUUID().toString().replaceAll("_","")%>" name="WIDout_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input  value="商品" type="text" name="WIDsubject" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" type="text" value="${totalPrice}" name="WIDtotal_amount" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
